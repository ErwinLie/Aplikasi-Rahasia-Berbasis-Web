                        ...
                        <form action="<?= base_url('home/aksi_e_profile')?>" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">                               
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label>Email</label>
                                        <input type="email" id="email" class="form-control" name="email" value="<?= esc($darren->email) ?>" required="">
                                        <div class="invalid-feedback">
                            ...
                            <button type="button" id="saveChangesButton" class="btn btn-primary" onclick="showOtpModal(this)" data-toggle="modal" data-target="#otpModal">Save Changes</button>
...
<script>
    ...
    form.addEventListener('submit', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { otp: otp, email: ema },
            dataType: 'json',
            success: function (response) {
                if (response.status === 'success') {
                    $('#otpModal').modal('hide'); // Tutup modal OTP
        ...
        // alert('Form submission is blocked!');
    });
</script>
...
<script>
    function showOtpModal(button) {
        ...
        $.ajax({
            url: '<?= base_url('home/isiemail') ?>', // Pastikan ini adalah URL yang sesuai
            type: 'POST',
